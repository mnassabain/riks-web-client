...
export function placeSoldier (evt) {
  ...
  console.log('free territories left : ' + MainGame.prototype.getFreeTerritoriesNumber());
  if(MainGame.prototype.getFreeTerritoriesNumber() > 0){
    if(MainGame.prototype.tryPutUnits() === true){
      if(MainGame.prototype.checkTerritoryFreedom(selectedCountryId) === true){
            ...
            if(res == 0){              
              ...
              if(continentName[countries].soldiers == 0){
                ...
                var temp = d3
                  ...
                  document.getElementById(selectedCountryId).style.fill = localStorage.myColor                  
              }
            }else{
        ...
        MainGame.prototype.chooseTerritory(MainGame.prototype.getCountryIdByName(selectedCountryId))
      }else{
        clearDisplayMessage()
